...
export default function BatteryTestingPage() {
  const service = getService('battery-testing');
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-up">
              ...
              <div className="prose max-w-none text-gray-700">
                <p className="mb-4">
                  Our Battery & Electrical Testing service provides comprehensive analysis of battery systems and electrical infrastructure. Using state-of-the-art testing equipment, we can assess the health and performance of your power systems.
                </p>
                <p className="mb-4">
                  Our testing process includes:
                </p>
                <ul className="list-disc pl-6 mb-4">
                  <li>Battery impedance and conductance testing</li>
                  <li>Load bank testing and capacity measurement</li>
                  <li>Internal resistance measurement</li>
                  <li>Temperature monitoring and thermal analysis</li>
                  <li>Detailed performance reporting and recommendations</li>
                </ul>
                <p>
                  Regular battery testing is essential for ensuring reliable backup power and preventing unexpected system failures.
                </p>
              </div>
            </div>
          </div>
