...
export default function PowerQualityAnalysisPage() {
  const service = getService('power-quality-analysis');
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-up">
              ...
              <div className="prose max-w-none text-gray-700">
                <p className="mb-4">
                  Power Quality Analysis is a comprehensive evaluation of your electrical power systems that helps identify and resolve power-related issues. Our advanced monitoring equipment measures various electrical parameters to ensure optimal system performance.
                </p>
                <p className="mb-4">
                  Our analysis includes:
                </p>
                <ul className="list-disc pl-6 mb-4">
                  <li>Voltage and current harmonics measurement</li>
                  <li>Power factor analysis and correction recommendations</li>
                  <li>Load balancing assessment</li>
                  <li>Transient detection and analysis</li>
                  <li>Energy consumption patterns and optimization strategies</li>
                </ul>
                <p>
                  Regular power quality analysis helps prevent equipment damage, reduce energy costs, and ensure reliable operation of your electrical systems.
                </p>
              </div>
            </div>
          </div>
