...
export default function VibrationAnalysisPage() {
  const service = getService('vibration-analysis');
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-up">
              ...
              <div className="prose max-w-none text-gray-700">
                <p className="mb-4">
                  Vibration Analysis is a powerful predictive maintenance technique that helps identify mechanical issues before they lead to equipment failure. Our advanced vibration monitoring equipment can detect and analyze various types of machine vibrations.
                </p>
                <p className="mb-4">
                  The analysis process involves:
                </p>
                <ul className="list-disc pl-6 mb-4">
                  <li>Data collection using high-precision sensors</li>
                  <li>Frequency spectrum analysis</li>
                  <li>Trend monitoring and pattern recognition</li>
                  <li>Root cause analysis</li>
                  <li>Detailed reporting with actionable recommendations</li>
                </ul>
                <p>
                  Regular vibration analysis is crucial for maintaining the health of rotating equipment and preventing unexpected breakdowns.
                </p>
              </div>
            </div>
          </div>
