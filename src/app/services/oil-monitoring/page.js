...
export default function OilMonitoringPage() {
  const service = getService('oil-monitoring');
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-up">
              ...
              <div className="prose max-w-none text-gray-700">
                <p className="mb-4">
                  Oil Condition Monitoring is a crucial diagnostic tool that helps assess the health of both the oil and the equipment it services. Through advanced analysis techniques, we can identify potential issues before they lead to equipment failure.
                </p>
                <p className="mb-4">
                  Our comprehensive analysis includes:
                </p>
                <ul className="list-disc pl-6 mb-4">
                  <li>Particle count and distribution analysis</li>
                  <li>Viscosity and oxidation testing</li>
                  <li>Contamination level assessment</li>
                  <li>Wear metal analysis</li>
                  <li>Water content measurement</li>
                </ul>
                <p>
                  Regular oil condition monitoring helps extend equipment life, optimize maintenance schedules, and prevent costly breakdowns.
                </p>
              </div>
            </div>
          </div>
